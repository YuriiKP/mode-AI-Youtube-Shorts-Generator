...
1. Очень эмоциональные моменты, потеря, разочарование и т.п. Или "крутые" момтены, которые могут зацепить.
2. ХУКИ — фразы, мгновенно вызывающие любопытство («Секрет в том, что...», «Никто не говорит об этом...», «Я полностью ошибался насчёт...»)
3. ПИКИ ИСТОРИЙ — кульминация или поворот истории; момент развязки
4. ПРАКТИЧЕСКАЯ ПОЛЬЗА — конкретный совет, лайфхак или инсайт, который зритель может сразу применить
