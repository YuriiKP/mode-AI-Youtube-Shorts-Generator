...
- Оптимальная длительность: 60-90 секунд (это примерная длина, можено изменять). Короче — только для идеального самодостаточного однострочника. Длиннее (91-180с) — только когда сюжетной арке нужен полный контекст, чтобы сработать
